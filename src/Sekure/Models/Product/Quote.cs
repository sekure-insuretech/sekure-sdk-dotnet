...
namespace Sekure.Models
{
    public class Quote
    {
        ...
        public Quote(List<CoverageResultAPI> coverages, List<InfoResultAPI> deductible, string startDate, string termTime, string premiumAmount, string premiumPaymentInterval, List<InfoResultAPI> beneficiaries, List<InfoResultAPI> gracePeriodsList, List<InputParameter> additionalInfo)
        {
            Coverages = coverages;
